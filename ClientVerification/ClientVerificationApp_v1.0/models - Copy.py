...
class Clientresponse(models.Model):
    ...
    clientmaster_accountid = models.ForeignKey(Clientmaster, db_column='ClientMaster_AccountId') # Field name made lowercase.
    iswebsiteworking = models.TextField(db_column='IsWebsiteWorking', blank=True) # Field name made lowercase. This field type is a guess.
    iscallpicked = models.TextField(db_column='IsCallPicked', blank=True) # Field name made lowercase. This field type is a guess.
    isonreminder = models.TextField(db_column='IsOnReminder', blank=True) # Field name made lowercase. This field type is a guess.
    wishtocontinue = models.TextField(db_column='WishToContinue', blank=True) # Field name made lowercase. This field type is a guess.
