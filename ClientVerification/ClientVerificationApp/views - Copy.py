...
from ClientVerificationApp.models import Reasonmaster,Clientresponse,Clientresponsereasons
...
def saveClientResponse(request):
	...
	with transaction.atomic():
		...
		clientResponse = Clientresponse(clientmaster_accountid=clientAccountId,iswebsiteworking=websiteOperational,iscallpicked=callAnswered,wishtocontinue='',
			additionalemailid='',additionalphone1='',additioanlphone2='',isonreminder='')
		clientResponse.save();
	...
	#print 'IsRemind' + clientResponse.isonreminder
	#clientResponse.save();
